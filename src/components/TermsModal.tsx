    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 flex justify-between items-center">
          <h2 className="text-2xl font-bold">Termeni și Condiții</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-8 overflow-y-auto flex-1">
          <div className="prose prose-sm max-w-none">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">1. Acceptarea Termenilor</h3>
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">2. Servicii Oferite</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">3. Confidențialitate și Protecția Datelor</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">4. Obligațiile Clientului</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">5. Limitarea Răspunderii</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">6. Proprietate Intelectuală</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">7. Modificări ale Termenilor</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">8. Rezilierea</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">9. Legea Aplicabilă și Jurisdicție</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">10. Contact</h3>
              <p className="text-gray-700 mb-3">
