    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 flex justify-between items-center">
          <h2 className="text-2xl font-bold">Politica de Confidențialitate</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-8 overflow-y-auto flex-1">
          <div className="prose prose-sm max-w-none">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">1. Introducere</h3>
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">2. Operatorul de Date</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">3. Datele Colectate</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">4. Scopul Prelucrării Datelor</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">5. Baza Legală a Prelucrării</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">6. Partajarea Datelor</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">7. Perioada de Stocare</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">8. Drepturile Dumneavoastră</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">9. Securitatea Datelor</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">10. Cookie-uri și Tehnologii Similare</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">11. Transferuri Internaționale</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">12. Minori</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">13. Modificări ale Politicii</h3>
              <p className="text-gray-700 mb-3">
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">14. Plângeri</h3>
              <p className="text-gray-700 mb-3">
              ...
              <p className="text-gray-700 mb-3">
                ...
                Website: <a href="https://www.dataprotection.ro" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">www.dataprotection.ro</a>
              </p>
            </section>
